...
class Blob:
    # Self = the object instance to share between the entire object/class
    # Reference using self.<attribute>
    # Self is the conventional name
    # The init method runs when a new instance of Blob is created
    # __init__ is known as a "magic method"
