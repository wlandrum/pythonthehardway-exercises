...
# Main task of spider is to go to website, find all the links on that website, and then follow those links, and so on.
...
def random_starting_url():
    # Choose 3 random lower case characters
...
def get_links(url):
    ...
    # Most case, will not need, but making active choice to make sure that anything outside doesn't get past exception
